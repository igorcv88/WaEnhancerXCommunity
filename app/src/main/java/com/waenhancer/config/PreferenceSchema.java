...
public final class PreferenceSchema {
    ...
    static {
        ...
        add(entries, "floating_bottom_bar_icon_label_spacing", Type.FLOAT, Sensitivity.PUBLIC_SETTING, Store.PUBLIC);
        add(entries, "floating_bottom_bar_icon_size", Type.FLOAT, Sensitivity.PUBLIC_SETTING, Store.PUBLIC);
        ...
        add(entries, "floating_bottom_bar_minimal_fab_margin", Type.FLOAT, Sensitivity.PUBLIC_SETTING, Store.PUBLIC);
        ...
        add(entries, "floating_bottom_bar_text_size", Type.FLOAT, Sensitivity.PUBLIC_SETTING, Store.PUBLIC);
